...
export function Hero({ aboutText }: { aboutText: string }) {
    return (
            ...
            <div className="container mx-auto">
                <div className="max-w-4xl">
                    ...
                    <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="text-lg md:text-xl text-slate-400 mb-10 max-w-2xl leading-relaxed">
                        {aboutText || "Nesne yönelimli programlama ve modern yazılım mimarileri üzerine çalışıyorum. Karmaşık problemleri Java teknolojileri ile çözmeye odaklıyım."}
                    </motion.p>
